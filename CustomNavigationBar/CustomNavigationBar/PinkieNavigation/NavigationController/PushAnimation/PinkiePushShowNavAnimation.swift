//
//  PinkiePushShowNavAnimation.swift
//  CustomNavigationBar
//
...
class PinkiePushShowNavAnimation: PinkieNavPushAnimation {

    var navigationView: PinkieNavigationView?
    
    override func navigationViewPerpare() {
        let nav = self.toVC.navigationController as? PinkieNavigationController
